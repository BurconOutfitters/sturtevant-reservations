...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  <h3 class='hndle' style="padding:5px;"><span>Advanced Settings</span></h3>
  <div class="inside">
...
<?php } ?>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
   ...
   <div id="bccf_optional_services_fields_link"> 
    <a href="javascript:bccf_toggle_osf()">Click to show optional services fields configuration...</a>
    <script type="text/javascript">
   ...
   <?php for ($k=1;$k<=DEX_BCCF_DEFAULT_SERVICES_FIELDS; $k++) { ?>
    <fieldset style="border: 1px solid #888888;">
     ...
     <table class="form-table">
        ...
        &nbsp; &nbsp; &nbsp; Type: <?php $option = dex_bccf_get_option('cp_cal_checkboxes_ftype'.$k, 0); ?>
          <select name="cp_cal_checkboxes_ftype<?php echo $k; ?>">
           <option value="0"<?php if ($option == '0') echo ' selected'; ?>>Dropdown</option>           
           <option value="1"<?php if ($option == '1') echo ' selected'; ?>>Radiobuttons</option>
           <option value="2"<?php if ($option == '2') echo ' selected'; ?>>Checkboxes</option>
          </select>
        </th>
        </tr>
        <tr valign="top">
        <td colspan="2">
          ...
          <option value="5"<?php if ($option == '5') echo ' selected'; ?>>Additional items field. The item price will be added ONCE PER WEEK.</option>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">
        <tr valign="top">
        <th scope="row">Email field on the form (all emails marked here will receive the notification, use CTRL+click for multiple selection)</th>
        <td><select multiple rows="10" id="cu_user_email_field" name="cu_user_email_field[]" def="<?php echo esc_attr(dex_bccf_get_option('cu_user_email_field', DEX_BCCF_DEFAULT_cu_user_email_field)); ?>"></select></td>
        </tr>
        <tr valign="top">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">  
     ...
     <table class="form-table">    
        <tr valign="top">
        <th scope="row">Enable follow-up email after booking date?</th>
        <td><input type="checkbox" name="enable_reminder2" id="enable_reminder2" onclick="bccf_checkreminderstatus();" size="40" value="1" <?php if (dex_bccf_get_option('enable_reminder2',0)) echo 'checked'; ?> /></td>
        </tr>  
     </table>        
     ...
     <script type="text/javascript">
       function bccf_checkreminderstatus() {
            ...
            if (document.getElementById("enable_reminder2").checked)
 ...
 <?php
	...
	{	
		...
		foreach( $dexbccf_addons_active_list as $addon_id ) if( isset( $dexbccf_addons_objs_list[ $addon_id ] ) ) print $dexbccf_addons_objs_list[ $addon_id ]->get_addon_form_settings( intval($_GET["cal"]) );
	}
 ?>
