...
<div class="wrap reservations reservation-submissions">
    ...
    <p class="reservations-admin-header-buttons">
        <input class="button" type="button" name="backbtn" value="<?php echo esc_attr__( 'Back to Forms', 'sc-res' ); ?>" onclick="document.location='admin.php?page=reservations';">
        <input class="button" type="button" name="noncbtn" value="<?php echo esc_attr__( 'Forms Not Completed', 'sc-res' ); ?>" onclick="document.location='admin.php?page=reservations&cal=<?php echo $_GET["cal"]; ?>&list2=1';">
    </p>
    <hr />
