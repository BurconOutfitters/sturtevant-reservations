	...
	<form method="post" name="dexconfigofrm" action="">
		...
		<section>
			...
			<div id="metabox_basic_settings_cal1" class="reservations-display-calendar">
				...
				?>
				<!-- <div>
					<strong>Note:</strong> Overlapped reservations are enabled below, so you cannot use the calendar to block dates and the reservation should be checked in the <a href="admin.php?page=reservations&cal=<?php // echo CP_BCCF_CALENDAR_ID; ?>&list=1">reservations list area</a>.
				</div> -->
				<?php else : ?>
				<script>
				...
				<div>
					<?php echo sprintf(
						...
						esc_attr( esc_url( 'admin.php?page=reservations&cal=' . CP_BCCF_CALENDAR_ID . '&list=1' ) ),
