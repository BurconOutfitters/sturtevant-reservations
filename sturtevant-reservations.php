...
require_once 'dex_data-source.inc.php';
...
function _dex_bccf_install() {
    ...
    $sql = "CREATE TABLE `".$wpdb->prefix.DEX_BCCF_CONFIG_TABLE_NAME."` (".
                   ...
                   "`enable_reminder2` VARCHAR(20) DEFAULT '' NOT NULL, ".
                   ...
                   "`cp_cal_checkboxes_ftype` varchar(10) DEFAULT '' NOT NULL,".
...
if ( is_admin() ) {
    ...
    function dex_bccf_admin_menu() {
        ...
        add_menu_page( 'Booking Calendar Contact Form Options', 'Booking Calend. Contact Form', 'edit_posts', 'dex_bccf', 'dex_bccf_html_post_page' );
    }
}
else
{
...
function dex_bccf_html_post_page() {
    if (isset($_GET["cal"]) && $_GET["cal"] != '')
    {
        if (isset($_GET["editk"]) && $_GET["editk"] == '1')
            ...
            @include_once dirname( __FILE__ ) . '/dex_bccf_admin_int_edit_booking.inc.php';    
        else if (isset($_GET["list2"]) && $_GET["list2"] == '1')
            @include_once dirname( __FILE__ ) . '/dex_bccf_admin_int_non_completed_bookings_list.inc.php';
        else    
