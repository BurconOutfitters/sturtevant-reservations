...
<div id="normal-sortables" class="meta-box-sortables">
	...
	<div id="metabox_basic_settings" class="postbox ">
	 <button type="button" class="handlediv button-link" aria-expanded="true"><span class="toggle-indicator" aria-hidden="true"></span></button>
	  <h2 class="hndle"><span>Instructions</span></h2>
	  <div class="inside">
		<h4 style="margin: 2em 0 0 0; line-height: 1em;">View Reservations:</h4>
		<p>Click the "Guest List" button to the right of the cabin option.</p>
		<h4 style="margin: 2em 0 0 0; line-height: 1em;">Calendar Updates:</h4>
		<p>If the main area or entire camp is reserved, make sure to block out the dates on the individual cabins, including the Honeymoon Cottage.<br />If one or more of the cabins is reserved, make sure to block out the dates on Main Area and Entire Camp because they can no longer be reserved as exclusive.</p>
		<p>To block out dates, click on the "Edit Form" button that corresponds with the cabin and click once on the dates to be blocked out in the calendar that says "Disabled and special dates." The blocked dates will turn red.
	  </div>    
	 </div>

 <div id="metabox_basic_settings" class="postbox" >
  <button type="button" class="handlediv button-link" aria-expanded="true"><span class="toggle-indicator" aria-hidden="true"></span></button>
  <h2 class="hndle"><span>Forms & Guest Lists</span></h2>
  <div class="inside">
  
  
  <table cellspacing="1"> 
   <tr>
    <th style="padding: 0 5px;" align="left">ID</th><th style="padding: 0 5px;" align="left">Form Name</th><th style="padding: 0 5px;" align="left">Owner</th><th style="padding: 0 5px;" align="left">Public</th><th style="padding: 0 5px;" align="left">&nbsp; &nbsp; &nbsp;Manage Forms</th><th style="padding: 0 5px;" align="left">Shortcode</th>
   </tr> 
<?php  
...
?>
   <tr> 
    ...
    <td nowrap>&nbsp; &nbsp; 
                             ...
                             <?php } ?>    
                             <input type="button" name="calmanage_<?php echo $item->id; ?>" value="Edit Form" onclick="cp_manageSettings(<?php echo $item->id; ?>);" /> &nbsp; 
                             <input type="button" name="calbookings_<?php echo $item->id; ?>" value="Guest List" onclick="cp_BookingsList(<?php echo $item->id; ?>);" /> &nbsp; 
...
<?php if (cp_bccf_is_administrator()) { ?> 
 ...
 <div id="metabox_basic_settings" class="postbox" >
  <h2 class='hndle' style="padding:5px;"><span>New Form</span></h2>
  <div class="inside"> 
   
    <form name="additem" style="font-weight: bold;">Name:<br />
