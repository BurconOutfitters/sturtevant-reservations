    ...
    (function ($) {
                ...
                $("#dp" + opt.id).datepicker({
                    ...
                    beforeShowDay: function (d) {
                        ...
                        if ((d > selectedDates.l && d < selectedDates.u)) {
                            ...
                            c = "specialDateStart";
                            if (opt.partialDate) co_l = opt.defaultColor;
                            else co = opt.defaultColor;
                            //n++;
                            ...
                            c = "specialDate" + ((opt.partialDate) ? "Right" : "");;
                            if (opt.partialDate) co_r = opt.defaultColor;
                            else co = opt.defaultColor;
                            //n++;
                        }
                        dString = "";
                        if (c != "") {
                            ...
                            dStringClass[dStringClass.length] = {
                                d: dString,
                                c: co,
                                co_l: co_l,
                                co_r: co_r,
            ...
            var saveData = function (ind, title, desc, c) {
                if (ind == "-1") {
                    $.post(opt.ajaxURL + "?dex_bccf_calendar_load2=add&id=" + opt.calendarId, [{
                            name: "startdate",
                            value: selectedDates.l.getFullYear() + "-" + (selectedDates.l.getMonth() + 1) + "-" + selectedDates.l.getDate()
                        },
                        {
                            name: "enddate",
                            value: selectedDates.u.getFullYear() + "-" + (selectedDates.u.getMonth() + 1) + "-" + selectedDates.u.getDate()
                        },
                        {
                            name: "title",
                            value: title
        ...
        function adaptWH() {
            $(".rcalendar").each(function () {
                ...
                if (h != 0) $(this).find(".ui-datepicker-group").each(function () {
                    $(this).css("height", h + "px");
                });
                if (w != 0) $(this).find(".ui-datepicker-group").each(function () {
                    $(this).css("width", (w) + "px");
                });
            });
        }
