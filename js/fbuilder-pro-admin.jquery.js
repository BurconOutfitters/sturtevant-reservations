	...
	$.fn.fbuilder = function (options) {
		...
		$.fbuilder['duplicateItem'] = function (index) {
			...
			items.splice(index * 1 + 1, 0, $.extend(true, {}, items[index], {
				name: "fieldname" + (n + 1)
			}));
